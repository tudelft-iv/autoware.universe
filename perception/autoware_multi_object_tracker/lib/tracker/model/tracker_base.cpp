  ...
  const std::vector<autoware_perception_msgs::msg::ObjectClassification> & input)
{
  ...
  // TODO: Be Aware! This variable gain was added in order to tune the tracker completely to making the
  // post-RSS demo work with the cyclist until we would have a better detector. It basically means that
  // we made the tracker sticky to believing something is a cyclist. However, the tracker of autoware
  // universe was updated and this 'trick' no longer applies (commented out) for autoware 0.50.2.
  // float gain = 5;
